    ...
    void OnGUI ()
    {
        ...
        GUILayout.BeginArea (rectArea);
        {
            ...
            GUILayout.BeginHorizontal ();
            {
				...
				textField = Application.streamingAssetsPath + "/AnimTextures/" + gifname;/*Resources.Load<Texture>("ts.gif");*///GUILayout.TextField (textField, GUILayout.Width ((float) Screen.width * 0.5f));
